...
const Chatbox = () => {
  ...
  return (
    ...
    max-md:mt-14 2xl:pr-40'>
     ...
     <div ref={containerRef}className='flex-1 mb-5 overflow-y-scroll'>
         {messages.length==0 && (
           <div className='h-full flex flex-col justify-center items-center gap-2'>
              ...
              <p className='mt-5 text-4xl sm:text-6xl text-center text-gray-400 dark:text-white animate-pulse'> 
                Ask Me Anything</p>
            </div>
         )}
     ...
     {/*prompt*/} 
     <form onSubmit={onSubmit} className='bg-primary/20 dark:bbg-[#583C79]/30 border border-primary dark:border-[#80609F]/30
     rounded-full w-full max-w-2xl p-3 pl-4 mx-auto flex gap-4 items-center'>
       ...
       <input onChange={(e)=>setPrompt(e.target.value)} className='flex-1 w-full text-sm outline-none'type='text' placeholder='Type your prompt here...' required/>
