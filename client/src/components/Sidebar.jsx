...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    <div className={`flex flex-col justify-between h-screen min-w-72 p-5 
      ...
      <div>
        ...
        <div className='mt-2 space-y-2 overflow-y-auto max-h-[40vh] pr-1'>
          {chats
            .filter((chat) =>
              chat.messages[0]
      ...
      <div className="space-y-4">
        ...
        <div 
          ...
          <div className='flex flex-col text-sm'>
            ...
            <p className='text-xs text-gray-400'>Purchase credits to use Genix</p>
          </div>
        </div>

        {/* Dark Mode Toggle */}
        <div className='flex items-center justify-between gap-2 p-3 border 
      ...
      <img 
        ...
        className='absolute top-3 right-4 w-5 h-5 cursor-pointer md:hidden not-dark:invert' 
        alt='' 
      />
    </div>
  )
